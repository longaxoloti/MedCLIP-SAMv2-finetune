...
class FreqAwareModel(nn.Module):
    ...
    def get_fused_features(self, images):
        """Get frequency-aware fused image features for CLIP training."""
    ...
    def get_text_features(self, texts):
        ...
        return text_output['pooler_output']  # [B, 768]


class Trainer:
    """
    Trainer for frequency-aware CLIP alignment (following brainstorm.md).
    ...
    def setup_stage(self, stage):
        ...
        if stage == 1:
            ...
            logger.info("=== STAGE 1: Warm-up Frequency Modules (CLIP Alignment) ===")
    ...
    def compute_loss(self, images, texts):
        """Compute CLIP contrastive loss with frequency-aware features."""
